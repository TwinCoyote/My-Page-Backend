...
El frontend en React debe:

* consumir la API
* renderizar los proyectos
* no depender del backend para diseño

---

## Notas importantes

* No usar templates de Django
* No mezclar frontend con backend
* Django solo expone datos

---

## Estado

Backend base listo para conectar con React.
...
Hecho para un flujo profesional y escalable.
